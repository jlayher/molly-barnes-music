        ...
        <div className={styles.academic__body_text_container}>
          ...
          <div className={styles.academic__body_text_teaching}>
            ...
            <p>
              ...
              getting to know my students as human beings with real lives, hopes,
              fears, and ambitions. My goal as a teacher--whether I am teaching
              music history, musicianship skills, or the violin--is to share my
              love of the subject such that my students are inspired to learn more
              and discover the joy that can come from a deep intellectual and
          ...
          <div className={styles.academic__body_text_research}>
            ...
            <p>
              ...
              in the U.S. and the U.K.; chamber music as a social phenomenon in
