...
const AcademicTeaching = () => {
  return (
    <Layout>
        ...
        <div className={styles.academic__title}>
          ...
          <div className={styles.academic__body_text_container}>
            ...
            <div className={styles.academic__body_text_teaching}>
              ...
              <p>
                ...
                teaching music history, musicianship skills, or the violin--is
                to share my love of the subject such that my students are
                inspired to learn more and discover the joy that can come from a
            ...
            <div className={styles.academic__body_text_research}>
              ...
              <p>
                ...
                1830-1870, explores mid-nineteenth-century American perceptions
                of the relationship between Western art music and the ideal of
